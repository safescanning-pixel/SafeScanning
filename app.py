"""
================================================================================
ALLERGY SHIELD PRO - KERNANWENDUNG
================================================================================
Entwickelt von: Marius Boulos, Benjamin Mehling, Sophie Hartwig, Ben Henkel, Maximilian Maier
Klasse: 10a (Hanns-Seidel-Gymnasium Aschaffenburg)

Architektur-Hinweise:
- Dieses Modul nutzt Streamlit für das Backend-Routing und UI-Rendering.
- Der Kamera-Scanner ist als isoliertes HTML5/JS-Component implementiert, um 
  native Performance auf iOS/iPadOS Geräten sicherzustellen.
- Die Kommunikation zwischen Frontend (Scanner) und Backend (Python) erfolgt 
  sicher und asynchron über st.query_params.
================================================================================
"""
...
# ==========================================
# Dieser Block fängt den gescannten Barcode aus der URL ab,
# sobald der JavaScript-Scanner die iFrame-Location aktualisiert.
...
st.markdown("""
    <style>
    /* Generelles Layout und Typografie */
    .stApp { 
    ...
    .result-box-safe { 
        ...
        animation: passGlow 1.5s infinite alternate;
    }
    .result-box-warn { 
        ...
        animation: failGlow 1.5s infinite alternate;
    }
...
def throw_confetti():
    """
    Löst eine visuelle Konfetti-Animation bei sicheren Produkten aus.
    Greift auf ein externes CDN für das Canvas-Rendering zu.
    """
    components.html(
        """
...
# ==========================================
# 3. GLOBAL STATE & SPRACH-ENGINE (12 Sprachen)
# ==========================================
# Initialisierung der Session States für persistente Daten
...
# Definition des Schutzprofils (Standardmäßig alles auf False)
...
# Vollständiges UI-Dictionary für internationale Skalierbarkeit
ui = {
    "Deutsch": {
        "t1": "👤 Profil",
        "t2": "📸 Scanner",
        ...
        "no_conn": "📡 Keine Verbindung zur Datenbank.",
    ...
    "English": {
        ...
        "save": "Save Profile",
        "cat_allergy": "Intolerances & Allergens",
        "cat_additives": "Additives",
        "cat_lifestyle": "Lifestyle & Religion",
        "laktose": "Lactose / Milk",
        "fruktose": "Fructose",
        "histamin": "Histamine",
        "sorbit": "Sorbitol",
        "gluten": "Gluten",
        ...
        "koscher": "Kosher",
        "scan_h": "Scanner",
        "scan_p": "Use the camera or enter the code manually",
        ...
        "no_conn": "📡 Connection lost.",
        "lang_select": "Choose language:",
        "saved_msg": "✅ Profile saved!",
        "team_title": "👥 Team Class 10a",
        "w_laktose": "🥛 Contains Lactose",
        "w_fruktose": "🍎 Contains Fructose",
        "w_histamin": "🍷 Histamine Risk",
        "w_sorbit": "🍬 Contains Sorbitol",
        "w_sulfite": "🧪 Contains Sulfites",
        "w_glutamat": "🍕 Contains Glutamate",
        "w_gluten": "🌾 Contains Gluten",
        "w_nuesse": "🌰 Contains Nuts",
        "w_soja": "🌱 Contains Soy",
        "w_erdnuesse": "🥜 Contains Peanuts",
        "w_vegan": "🥩 Not Vegan",
        "w_vegetarisch": "🥩 Not Vegetarian",
        "w_halal": "☪️ Not Halal",
        "w_koscher": "✡️ Not Kosher",
    ...
    "日本語": {
        ...
        "koscher": "コーシャ",
        "scan_h": "スキャナー",
        "scan_p": "カメラか手動でバーコードを入力してください",
        "btn_cam_start": "📸 スキャナーを起動",
        "btn_cam_stop": "🛑 スキャナーを停止",
        "safe": "✅ 安全な製品です！",
        "safe_sub": "プロファイルに完全に一致しています。",
        "warn": "🛑 適合しません！",
        "not_found": "⚠️ 製品が見つかりません。",
        "no_conn": "📡 データベース接続エラー。",
        "lang_select": "言語を選択:",
        "saved_msg": "✅ 保存されました！",
        "team_title": "👥 開発チーム 10aクラス",
        "w_laktose": "🥛 乳成分含有",
        "w_fruktose": "🍎 果糖含有",
        "w_histamin": "🍷 ヒスタミンのリスク",
        "w_sorbit": "🍬 ソルビトール含有",
        "w_sulfite": "🧪 亜硫酸塩含有",
        "w_glutamat": "🍕 グルタミン酸含有",
        "w_gluten": "🌾 グルテン含有",
    ...
    "العربية": {
        ...
        "t3": "⚙️ الإعدادات",
        "t4": "ℹ️ معلومات",
        "title": "ملف الحماية الخاص بي",
        "sub": "قم بتكوين الحساسية والتفضيلات الغذائية",
        "save": "حفظ الملف",
        "cat_allergy": "الحساسية وعدم التحمل",
        "cat_additives": "المواد المضافة",
        "cat_lifestyle": "نمط الحياة والدين",
        "laktose": "اللاكتوز / الحليب",
        "fruktose": "الفركتوز",
        "histamin": "الهيستامين",
        "sorbit": "السوربيتول",
        "gluten": "الغلوتين",
        ...
        "halal": "حلال",
        "koscher": "كوشير",
        "scan_h": "الماسح الضوئي",
        "scan_p": "استخدم الكاميرا أو أدخل الرمز يدويًا",
        "btn_cam_start": "📸 تشغيل الماسح",
        "btn_cam_stop": "🛑 إيقاف الماسح",
        "safe": "✅ المنتج آمن ومناسب!",
        "safe_sub": "هذا المنتج يطابق ملفك الشخصي تمامًا.",
        "warn": "🛑 غير مناسب!",
        "not_found": "⚠️ لم يتم العثور على المنتج.",
        "no_conn": "📡 لا يوجد اتصال بالخادم.",
        "lang_select": "اختر اللغة:",
        "saved_msg": "✅ تم حفظ الملف بنجاح!",
        "team_title": "👥 فريق التطوير الصف 10a",
        "w_laktose": "🥛 يحتوي على اللاكتوز/الحليب",
        "w_fruktose": "🍎 يحتوي على الفركتوز",
        "w_histamin": "🍷 خطر الهيستامين",
        "w_sorbit": "🍬 يحتوي على السوربيتول",
        "w_sulfite": "🧪 يحتوي على الكبريتيت",
        "w_glutamat": "🍕 يحتوي على الغلوتامات",
        "w_gluten": "🌾 يحتوي على الغلوتين",
        "w_nuesse": "🌰 يحتوي على المكسرات",
        "w_soja": "🌱 يحتوي على الصويا",
        "w_erdnuesse": "🥜 يحتوي على الفول السوداني",
        "w_vegan": "🥩 ليس نباتيًا تامًا",
        "w_vegetarisch": "🥩 ليس نباتيًا",
        "w_halal": "☪️ غير متوافق مع الحلال",
        "w_koscher": "✡️ غير متوافق مع الكوشير",
        "placeholder": "أدخل الباركود...",
        "hist_title": "🕒 السجل",
        "details": "🔬 المكونات والتحليل"
    },
    "简体中文": {
        "t1": "👤 个人档案",
        "t2": "📸 扫描仪",
        ...
        "koscher": "犹太洁食",
        "scan_h": "扫描仪",
        "scan_p": "使用摄像头或手动输入条形码",
        "btn_cam_start": "📸 开启扫描",
        "btn_cam_stop": "🛑 关闭扫描",
        "safe": "✅ 产品安全可用！",
        "safe_sub": "该产品完全符合您的安全配置。",
        "warn": "🛑 不适用该产品！",
        "not_found": "⚠️ 未找到该产品。",
        "no_conn": "📡 无法连接到数据库。",
        "lang_select": "选择语言:",
        "saved_msg": "✅ 档案保存成功！",
        "team_title": "👥 10a 班级开发团队",
        "w_laktose": "🥛 含有乳糖/牛奶",
        "w_fruktose": "🍎 含有过糖",
        "w_histamin": "🍷 存在组胺风险",
        "w_sorbit": "🍬 含有山梨糖醇",
    ...
    "Русский": {
        ...
        "t3": "⚙️ Настройки",
        "t4": "ℹ️ Инфо",
        "title": "Мой профиль защиты",
        "sub": "Настройте ваши аллергии и предпочтения",
        "save": "Сохранить",
        "cat_allergy": "Непереносимость и аллергены",
        "cat_additives": "Добавки",
        "cat_lifestyle": "Образ жизни",
        "laktose": "Лактоза / Молоко",
        "fruktose": "Фруктоза",
        "histamin": "Гистамин",
        "sorbit": "Сорбит",
        "gluten": "Глютен",
        ...
        "glutamat": "Глутамат",
        "vegan": "Веган",
        "vegetarisch": "Вегетарианец",
        "halal": "Халяль",
        "koscher": "Кошерно",
        "scan_h": "Сканер",
        "scan_p": "Используйте камеру или введите штрихкод",
        "btn_cam_start": "📸 Запустить сканер",
        "btn_cam_stop": "🛑 Остановить сканер",
        "safe": "✅ ПРОДУКТ БЕЗОПАСЕН!",
        "safe_sub": "Полностью соответствует вашему профилю.",
        "warn": "🛑 НЕ ПОДХОДИТ!",
        "not_found": "⚠️ Продукт не найден.",
        "no_conn": "📡 Нет соединения с базой.",
        "lang_select": "Выберите язык:",
        "saved_msg": "✅ Профиль сохранен!",
        "team_title": "👥 Разработчики: Класс 10a",
        "w_laktose": "🥛 Содержит лактозу/молоко",
        "w_fruktose": "🍎 Содержит фруктозу",
        "w_histamin": "🍷 Риск гистамина",
        "w_sorbit": "🍬 Содержит сорбит",
        "w_sulfite": "🧪 Содержит сульфиты",
        "w_glutamat": "🍕 Содержит глутамат",
        "w_gluten": "🌾 Содержит глютен",
        "w_nuesse": "🌰 Содержит орехи",
        "w_soja": "🌱 Содержит сою",
        "w_erdnuesse": "🥜 Содержит арахис",
        "w_vegan": "🥩 Не веганский продукт",
        "w_vegetarisch": "🥩 Не вегетарианский",
        "w_halal": "☪️ Не халяльно",
        "w_koscher": "✡️ Не кошерно",
        "placeholder": "Введите штрихкод...",
        "hist_title": "🕒 История сканов",
        "details": "🔬 Ингредиенты и анализ"
    },
    "Polski": {
        "t1": "👤 Profil",
        "t2": "📸 Skaner",
        "t3": "⚙️ Ustawienia",
        "t4": "ℹ️ Info",
        "title": "Mój Profil Ochronny",
        "sub": "Skonfiguruj swoje alergie i nietolerancje",
        "save": "Zapisz profil",
        "cat_allergy": "Nietolerancje i Alergeny",
        "cat_additives": "Dodatki",
        "cat_lifestyle": "Styl życia i Religia",
        "laktose": "Laktoza / Mleko",
        "fruktose": "Fruktoza",
        "histamin": "Histamina",
        "sorbit": "Sorbitol",
        "gluten": "Gluten",
        "nuesse": "Orzechy",
        "soja": "Soja",
        "erdnuesse": "Orzeszki ziemne",
        "sulfite": "Siarczyny",
        "glutamat": "Glutaminian",
        "vegan": "Weganin",
        "vegetarisch": "Wegetarianin",
        "halal": "Halal",
        "koscher": "Koszerny",
        "scan_h": "Skaner",
        "scan_p": "Użyj aparatu lub wpisz kod ręcznie",
        "btn_cam_start": "📸 Uruchom skaner",
        "btn_cam_stop": "🛑 Zatrzymaj skaner",
        "safe": "✅ PRODUKT BEZPIECZNY!",
        "safe_sub": "Ten produkt jest w pełni zgodny z Twoim profilem.",
        "warn": "🛑 NIEODPOWIEDNI!",
        "not_found": "⚠️ Nie znaleziono produktu.",
        "no_conn": "📡 Brak połączenia z bazą danych.",
        "lang_select": "Wybierz język:",
        "saved_msg": "✅ Profil zapisany pomyślnie!",
        "team_title": "👥 Zespół programistów Klasa 10a",
        "w_laktose": "🥛 Zawiera laktozę/mleko",
        "w_fruktose": "🍎 Zawiera fruktozę",
        "w_histamin": "🍷 Ryzyko histaminy",
        "w_sorbit": "🍬 Zawiera sorbitol",
        "w_sulfite": "🧪 Zawiera siarczyny",
        "w_glutamat": "🍕 Zawiera glutaminian",
        "w_gluten": "🌾 Zawiera gluten",
        "w_nuesse": "🌰 Zawiera orzechy",
        "w_soja": "🌱 Zawiera soję",
        "w_erdnuesse": "🥜 Zawiera orzeszki ziemne",
        "w_vegan": "🥩 Nie dla wegan",
        "w_vegetarisch": "🥩 Nie dla wegetarian",
        "w_halal": "☪️ Niezgodny z Halal",
        "w_koscher": "✡️ Niezgodny z Koszer",
        "placeholder": "Wpisz kod kreskowy...",
        "hist_title": "🕒 Ostatnie skany",
        "details": "🔬 Składniki i analiza"
    },
    "Français": {
        "t1": "👤 Profil",
        "t2": "📸 Scanner",
        "t3": "⚙️ Réglages",
        "t4": "ℹ️ Info",
        "title": "Mon Profil de Protection",
        "sub": "Configurez vos allergies et préférences",
        "save": "Enregistrer",
        "cat_allergy": "Intolérances & Allergènes",
        "cat_additives": "Additifs",
        "cat_lifestyle": "Style de vie & Religion",
        "laktose": "Lactose / Lait",
        "fruktose": "Fructose",
        "histamin": "Histamine",
        "sorbit": "Sorbitol",
        "gluten": "Gluten",
        "nuesse": "Fruits à coque",
        "soja": "Soja",
        "erdnuesse": "Arachides",
        "sulfite": "Sulfites",
        "glutamat": "Glutamate",
        ...
        "koscher": "Cascher",
        "scan_h": "Scanner",
        "scan_p": "Utilisez l'appareil photo ou tapez le code",
        "btn_cam_start": "📸 Activer le scanner",
        "btn_cam_stop": "🛑 Arrêter le scanner",
        "safe": "✅ PRODUIT SÛR !",
        "safe_sub": "Ce produit correspond parfaitement à votre profil.",
        "warn": "🛑 NON COMPATIBLE !",
        "not_found": "⚠️ Produit non trouvé.",
        "no_conn": "📡 Connexion perdue.",
        "lang_select": "Langue :",
        "saved_msg": "✅ Profil enregistré !",
        "team_title": "👥 Équipe Classe 10a",
        "w_laktose": "🥛 Contient du lactose/lait",
        "w_fruktose": "🍎 Contient du fructose",
        "w_histamin": "🍷 Risque histamine",
        "w_sorbit": "🍬 Contient du sorbitol",
        "w_sulfite": "🧪 Contient des sulfites",
        "w_glutamat": "🍕 Contient du glutamate",
        "w_gluten": "🌾 Contient du gluten",
        "w_nuesse": "🌰 Contient des fruits à coque",
        "w_soja": "🌱 Contient du soja",
        "w_erdnuesse": "🥜 Contient des arachides",
        "w_vegan": "🥩 Non Végétalien",
        "w_vegetarisch": "🥩 Non Végétarien",
        "w_halal": "☪️ Non Halal",
        "w_koscher": "✡️ Non Cascher",
        "placeholder": "Entrez le code-barres...",
        "hist_title": "🕒 Historique",
        "details": "🔬 Ingrédients & Analyse"
    },
    "Español": {
        "t1": "👤 Perfil",
        "t2": "📸 Escáner",
        "t3": "⚙️ Ajustes",
        "t4": "ℹ️ Info",
        "title": "Mi Perfil de Protección",
        "sub": "Configura tus allergies e intolerancias",
        "save": "Guardar Perfil",
        "cat_allergy": "Intolerancias y Alérgenos",
        "cat_additives": "Aditivos",
        "cat_lifestyle": "Estilo de vida",
        "laktose": "Lactosa / Leche",
        "fruktose": "Fructosa",
        "histamin": "Histamina",
        "sorbit": "Sorbitol",
        "gluten": "Gluten",
        "nuesse": "Frutos de cáscara",
        "soja": "Soja",
        "erdnuesse": "Cacahuetes",
        "sulfite": "Sulfitos",
        "glutamat": "Glutamato",
        "vegan": "Vegano",
        ...
        "koscher": "Kosher",
        "scan_h": "Escáner",
        "scan_p": "Usa la cámara o introduce el código manualmente",
        "btn_cam_start": "📸 Iniciar Escáner",
        "btn_cam_stop": "🛑 Detener Escáner",
        "safe": "✅ ¡PRODUCTO APTO!",
        "safe_sub": "Este producto cumple con tu perfil de protección.",
        "warn": "🛑 ¡NO COMPATIBLE!",
        "not_found": "⚠️ Producto no encontrado.",
        "no_conn": "📡 Sin conexión.",
        "lang_select": "Idioma:",
        "saved_msg": "✅ ¡Perfil guardado con éxito!",
        "team_title": "👥 Equipo Clase 10a",
        "w_laktose": "🥛 Contiene lactosa/leche",
        "w_fruktose": "🍎 Contiene fructosa",
        "w_histamin": "🍷 Riesgo de histamina",
        "w_sorbit": "🍬 Contiene sorbitol",
        "w_sulfite": "🧪 Contiene sulfitos",
        "w_glutamat": "🍕 Contiene glutamato",
        "w_gluten": "🌾 Contiene gluten",
        "w_nuesse": "🌰 Contiene frutos de cáscara",
        "w_soja": "🌱 Contiene soja",
        "w_erdnuesse": "🥜 Contiene cacahuetes",
        "w_vegan": "🥩 No Vegano",
        "w_vegetarisch": "🥩 No Vegetariano",
        "w_halal": "☪️ No Halal",
        "w_koscher": "✡️ No Kosher",
        "placeholder": "Escribe el código...",
        "hist_title": "🕒 Historial",
        "details": "🔬 Ingredientes y Análisis"
    },
    "Português": {
        "t1": "👤 Perfil",
        "t2": "📸 Scanner",
        "t3": "⚙️ Definições",
        "t4": "ℹ️ Info",
        "title": "Meu Perfil de Proteção",
        "sub": "Configure as suas allergies e preferências",
        "save": "Salvar Perfil",
        "cat_allergy": "Intolerâncias e Alérgenos",
        "cat_additives": "Aditivos",
        "cat_lifestyle": "Estilo de vida",
        "laktose": "Lactose / Leite",
        "fruktose": "Frutose",
        "histamin": "Histamina",
        "sorbit": "Sorbitol",
        "gluten": "Glúten",
        "nuesse": "Frutos de casca rija",
        "soja": "Soja",
        "erdnuesse": "Amendoins",
        "sulfite": "Sulfitos",
        "glutamat": "Glutamato",
        ...
        "koscher": "Kosher",
        "scan_h": "Scanner",
        "scan_p": "Use a câmara ou digite o código manualmente",
        "btn_cam_start": "📸 Iniciar Scanner",
        "btn_cam_stop": "🛑 Parar Scanner",
        "safe": "✅ PRODUTO SEGURO!",
        "safe_sub": "Este produto está em conformidade com o seu perfil.",
        "warn": "🛑 NÃO COMPATÍVEL!",
        "not_found": "⚠️ Produto não encontrado.",
        "no_conn": "📡 Sem ligação.",
        "lang_select": "Idioma:",
        "saved_msg": "✅ Perfil saved com sucesso!",
        "team_title": "👥 Equipa Classe 10a",
        "w_laktose": "🥛 Contém lactose/leite",
        "w_fruktose": "🍎 Contém frutose",
        "w_histamin": "🍷 Risco de histamina",
        "w_sorbit": "🍬 Contém sorbitol",
        "w_sulfite": "🧪 Contém sulfitos",
        "w_glutamat": "🍕 Contém glutamato",
        "w_gluten": "🌾 Contém glúten",
        "w_nuesse": "🌰 Contém frutos de casca rija",
        "w_soja": "🌱 Contém soja",
        "w_erdnuesse": "🥜 Contém amendoins",
        "w_vegan": "🥩 Não Vegano",
        "w_vegetarisch": "🥩 Não Vegetariano",
        "w_halal": "☪️ Não Halal",
        "w_koscher": "✡️ Não Kosher",
        "placeholder": "Digite o código...",
        "hist_title": "🕒 Histórico",
        "details": "🔬 Ingredientes e Análise"
    },
    "ไทย": {
        "t1": "👤 โปรไฟล์",
        "t2": "📸 เครื่องสแกน",
        "t3": "⚙️ ตั้งค่า",
        "t4": "ℹ️ ข้อมูล",
        "title": "โปรไฟล์การป้องกันของฉัน",
        "sub": "ตั้งค่าการแพ้อาหารและข้อจำกัดของคุณ",
        "save": "บันทึกโปรไฟล์",
        "cat_allergy": "การแพ้อาหารและสารก่อภูมิแพ้",
        "cat_additives": "สารเจือปน",
        "cat_lifestyle": "ไลฟ์สไตล์และศาสนา",
        "laktose": "แลคโตส / นม",
        "fruktose": "ฟรุกโตส",
        "histamin": "ฮิสตามีน",
        "sorbit": "ซอร์บิทอล",
        "gluten": "กลูเตน",
        "nuesse": "ถั่วเปลือกแข็ง",
        "soja": "ถั่วเหลือง",
        "erdnuesse": "ถั่วลิสง",
        "sulfite": "ซัลไฟต์",
        "glutamat": "ผงชูรส",
        ...
        "koscher": "โคเชอร์",
        "scan_h": "เครื่องสแกน",
        "scan_p": "ใช้กล้องสแกนหรือพิมพ์รหัสบาร์โค้ด",
        "btn_cam_start": "📸 เริ่มต้นการสแกน",
        "btn_cam_stop": "🛑 หยุดการสแกน",
        "safe": "✅ สินค้าปลอดภัยทานได้!",
        "safe_sub": "สินค้านี้ตรงกับโปรไฟล์ความปลอดภัยของคุณอย่างสมบูรณ์",
        "warn": "🛑 ไม่ปลอดภัย / ห้ามทาน!",
        "not_found": "⚠️ ไม่พบสินค้า",
        "no_conn": "📡 การเชื่อมต่อล้มเหลว",
        "lang_select": "เลือกภาษา:",
        "saved_msg": "✅ บันทึกโปรไฟล์สำเร็จ!",
        "team_title": "👥 ทีมผู้พัฒนา ชั้น ม.4/a",
        "w_laktose": "🥛 มีส่วนผสมของแลคโตส/นม",
        "w_fruktose": "🍎 มีส่วนผสมของฟรุกโตส",
        "w_histamin": "🍷 มีความเสี่ยงจากฮิสตามีน",
        "w_sorbit": "🍬 มีส่วนผสมของซอร์บิทอล",
        "w_sulfite": "🧪 มีส่วนผสมของซัลไฟต์",
        "w_glutamat": "🍕 มีส่วนผสมของผงชูรส",
        "w_gluten": "🌾 มีส่วนผสมของกลูเตน",
        "w_nuesse": "🌰 มีส่วนผสมของถั่วเปลือกแข็ง",
        "w_soja": "🌱 มีส่วนผสม of ถั่วเหลือง",
        "w_erdnuesse": "🥜 มีส่วนผสมของถั่วลิสง",
        "w_vegan": "🥩 ไม่ใช่วีแกน",
        "w_vegetarisch": "🥩 ไม่ใช่มังสวิรัติ",
        "w_halal": "☪️ ไม่ผ่านมาตรฐานฮาลาล",
        "w_koscher": "✡️ ไม่ผ่านมาตรฐานโคเชอร์",
        "placeholder": "พิมพ์บาร์โค้ด...",
        "hist_title": "🕒 ประวัติการสแกน",
        "details": "🔬 ส่วนผสมและการวิเคราะห์"
    },
    "한국어": {
        "t1": "👤 프로필",
        "t2": "📸 스캐너",
        ...
        "t4": "ℹ️ 정보",
        "title": "내 보호 프로필",
        "sub": "알레르기 및 식단 선호도 설정",
        "save": "프로필 저장",
        "cat_allergy": "불내증 및 알레르기",
        "cat_additives": "첨가물",
        "cat_lifestyle": "라이프스타일 및 종교",
        "laktose": "유당 / 우유",
        "fruktose": "과당",
        "histamin": "히스타민",
        "sorbit": "소르비톨",
        ...
        "koscher": "코셔",
        "scan_h": "스캐너",
        "scan_p": "카메라를 사용하거나 바코드를 직접 입력하세요",
        "btn_cam_start": "📸 스캐너 시작",
        "btn_cam_stop": "🛑 스캐너 중지",
        "safe": "✅ 안전한 제품입니다!",
        "safe_sub": "당신의 보호 프로필과 완벽하게 일치합니다.",
        "warn": "🛑 적합하지 않습니다!",
        "not_found": "⚠️ 제품을 찾을 수 없습니다.",
        "no_conn": "📡 데이터베이스 연결 끊김.",
        "lang_select": "언어 선택:",
        "saved_msg": "✅ 프로필이 저장되었습니다!",
        "team_title": "👥 개발 팀 10a 클래스",
        "w_laktose": "🥛 유당/우유 포함",
        "w_fruktose": "🍎 과당 포함",
        "w_histamin": "🍷 히스타민 위험 감지",
        "w_sorbit": "🍬 소르비톨 포함",
        "w_sulfite": "🧪 아황산염 포함",
        "w_glutamat": "🍕 글루타민산염 포함",
        "w_gluten": "🌾 글루텐 포함",
        "w_nuesse": "🌰 견과류 포함",
        "w_soja": "🌱 대두 포함",
        "w_erdnuesse": "🥜 땅콩 포함",
        "w_vegan": "🥩 비건이 아님",
        "w_vegetarisch": "🥩 채식이 아님",
        "w_halal": "☪️ 할랄 미인증",
        "w_koscher": "✡️ 코셔 미인증",
        "placeholder": "바코드 입력...",
        "hist_title": "🕒 스캔 기록",
...
# ==========================================
# 4. OFFLINE BACKUP DATA (Inklusive Ahoj-Brause)
# ==========================================
OFFLINE_DATA = {
    "3017620425035": {
    ...
    "40335711": {
        ...
        "ingredients_text": "Zucker, Säuerungsmittel: Weinsäure (L+), Säureregulator: Natriumhydrogencarbonat, Süßungsmittel: Natriumcyclamat, Acesulfam-K und Saccharin-Natrium, Aromen, Farbstoffe: Karotine, E141, Anthocyane.", 
        "image_front_url": ""
    },
    "4002234027733": {
        "product_name": "Knoppers",
        "ingredients_text": "Zucker, pflanzliche Fette (Palm, Shea), Magermilchpulver (13,5%), Weizenmehl (12,3%), Haselnüsse (9,1%), Vollkornweizenmehl (6,1%), Kakao, Butterreinfett, Magerkakao, Weizenstärke, Emulgator Lecithine (Soja), Molkenerzeugnis.",
        "image_front_url": ""
    },
    "4006544418208": {
        "product_name": "Test Produkt (Offline-Fallback)",
        "ingredients_text": "Dies ist ein generierter Fallback für den Barcode 4006544418208 aus dem Testbild.",
        "image_front_url": ""
    }
}
...
function startScanner() {
    ...
    // Konfiguration optimiert für iOS/iPadOS Safari: fps auf 10 reduziert für bessere Performance
    const config = { fps: 10 };
    ...
    html5QrCode.start(
        ...
        (decodedText) => {
            ...
            // 2. Code an Streamlit senden (ohne iFrame-Verletzung)
            setTimeout(() => {
        ...
        // Fallback-Mechanismus, falls {exact: "environment"} vom iPad abgelehnt wird
        html5QrCode.start(
    ...
    if barcode_input:
        ...
        if len(barcode) >= 8:
            with st.spinner("🔍 ..."):
                ...
                # Fallback zur Offline-Datenbank
                ...
                if product:
                    ...
                    # LOGIK: Allergie-Checks auswerten
